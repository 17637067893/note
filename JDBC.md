...
```
在要生成测试类的类里面，按ctrl+shift+t –> create new test
```
...
概述![image-20201217110254419](G:\note\image\image-20201217110254419.png)

1. spring轻量级的开源的JavaEE框架
2. 有两个核心IOC 和AOP
...
![image-20201217125058767](G:\note\image\image-20201217125058767.png)

![image-20201217125106651](G:\note\image\image-20201217125106651.png)
...
3 创建 g Spring 配置文件，在配置文件配置创建的对象

![image-20201217125206772](G:\note\image\image-20201217125206772.png)
...
< bean id= "course1" class= "com.atguigu.spring5.collectiontype.Course">
 ...
 < bean id= "course2" class= "com.atguigu.spring5.collectiontype.Course">                                      < property name= "cname" value=s "MyBatis 框架" "></ property>
 </ bean>
<!--注入 list 集合类型，值是对象-->
...
在 Spring 里面 里面，默认情况下， ，默认情况下，bean 是单实例对象

![image-20201217141613952](G:\note\image\image-20201217141613952.png)

![image-20201217141621549](G:\note\image\image-20201217141621549.png)
...
![image-20201217141639659](G:\note\image\image-20201217141639659.png)

![image-20201217141647694](G:\note\image\image-20201217141647694.png)
...
（3 3 ）把 n bean 实例传递 n bean 后置处理器的方 postProcessBeforeInitialization
...
![image-20201217150450069](G:\note\image\image-20201217150450069.png)

2 、引入外部属性文件配置数据库连接池
（1）创建外部属性文件，properties 格式文件，写数据库信息

![image-20201217150524871](G:\note\image\image-20201217150524871.png)
...
* 引入 context 名称空间
  ...
  ![image-20201217152526989](G:\note\image\image-20201217152526989.png)
  ...
  第一步 把 service 和 dao 对象创建，在 service 和 dao实现类 类添加创建对象注解
  第二步 在 service 注入 dao实现类 对象，在 service 类添加 dao 类型属性，在属性上面使用注解
  ...
  @Qualifier：根据名称进行注入
  这个@Qualifier 注解的使用，和上面@Autowired 一起使用(方式统一抽象类有多个实现类,在实现类中挑选具体一个)
...
![image-20201217163108358](G:\note\image\image-20201217163108358.png)
...
![image-20201217163144995](G:\note\image\image-20201217163144995.png)

第二种 第二种 没有接口情况，使用 CGLIB 动态代理
⚫ 创建子类的代理对象，增强类的方法

![image-20201217163204444](G:\note\image\image-20201217163204444.png)
...
![image-20201217171310324](G:\note\image\image-20201217171310324.png)
...
class UserDaoProxy implements InvocationHandler {
    ...
    public UserDaoProxy(Object obj) {
        this. obj = obj;
            ...
            //增强的逻辑
   @Override
   publ ic Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        //方法之前
...
![image-20201217172728279](G:\note\image\image-20201217172728279.png)

![image-20201217172738411](G:\note\image\image-20201217172738411.png)

![image-20201217172745158](G:\note\image\image-20201217172745158.png)

![image-20201217172755676](G:\note\image\image-20201217172755676.png)

![image-20201217172804461](G:\note\image\image-20201217172804461.png)
...
![image-20201217174009135](G:\note\image\image-20201217174009135.png)
...
![image-20201217203629423](G:\note\image\image-20201217203629423.png)

![image-20201217203637708](G:\note\image\image-20201217203637708.png)
